...
export function RecipeDetail({ recipe, chooseOnly = false }: { recipe: Recipe; chooseOnly?: boolean }) {
  ...
  return <main className="recipe-detail">
    <a href={chooseOnly ? '#/choose' : '#/'}>{chooseOnly ? '返回点菜' : '返回食谱'}</a><h1>{recipe.title}</h1>
